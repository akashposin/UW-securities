...
const Requests = () => {
  ...
  const hideSourcesAndLayers = (mapInstance, floorNotToHide) => {
    ...
    floorArray.forEach((floor) => {
      ...
      if (floor === 'second-floor') {
        ...
        mapInstance.setLayoutProperty(
          'hidden-area-layer-outline',
          'visibility',
          leyerVisibility
        );
        mapInstance.setLayoutProperty(
          'hidden-layer-border-hover',
          'visibility',
          leyerVisibility
        );
        mapInstance.setLayoutProperty(
      ...
      mapInstance.setLayoutProperty(
        `${floor}-border-area-layer`,
        'visibility',
        leyerVisibility
      );
      mapInstance.setLayoutProperty(
        `${floor}-border-area-layer-outline`,
        'visibility',
        leyerVisibility
      );
      mapInstance.setLayoutProperty(
        `${floor}-border-layer-hover`,
        'visibility',
        leyerVisibility
      );
      mapInstance.setLayoutProperty(
        `${floor}-border-layer-border-hover`,
        'visibility',
        leyerVisibility
      );
      mapInstance.setLayoutProperty(
        `${floor}-mouseover-area-layer`,
        'visibility',
        leyerVisibility
      );
      mapInstance.setLayoutProperty(
        `${floor}-mouseover-area-layer-outline`,
        'visibility',
        leyerVisibility
      );
      mapInstance.setLayoutProperty(
        `${floor}-mouseover-layer-hover`,
        'visibility',
        leyerVisibility
      );
      mapInstance.setLayoutProperty(
        `${floor}-mouseover-layer-border-hover`,
        'visibility',
        leyerVisibility
      );
      mapInstance.setLayoutProperty(
        `${floor}-wall-area-layer-outline`,
        'visibility',
        leyerVisibility
      );
    });
  ...
  const fourthFloorAreaSourceAndLayers = (mapInstance) => {
    ...
    if (
      mapInstance.getSource('fourth-floor-border-area-source') &&
      mapInstance.getSource('fourth-floor-wall-area-source') &&
      mapInstance.getSource('fourth-floor-mouseover-area-source')
    )
      return;
    ...
    mapInstance.on(
      'mouseleave',
      'fourth-floor-mouseover-area-layer',
      function () {
        mapInstance.setFilter('fourth-floor-mouseover-layer-hover', [
          'in',
          'ALIAS_NAME',
  ...
  const thirdFloorAreaSourceAndLayers = (mapInstance) => {
    // border layer working properly
    if (
      mapInstance.getSource('third-floor-border-area-source') &&
      mapInstance.getSource('third-floor-mouseover-area-source') &&
      mapInstance.getSource('third-floor-wall-area-source')
    )
      return;
    ...
    mapInstance.on(
      'mouseleave',
      'third-floor-mouseover-area-layer',
      function () {
        mapInstance.setFilter('third-floor-mouseover-layer-hover', [
          'in',
          'ALIAS_NAME',
  ...
  const firstFloorAreaSourceAndLayers = (mapInstance) => {
    // border layer working properly
    if (
      mapInstance.getSource('first-floor-border-area-source') &&
      mapInstance.getSource('first-floor-mouseover-area-source') &&
      mapInstance.getSource('first-floor-wall-area-source')
    )
      return;
    ...
    mapInstance.on(
      'mouseleave',
      'first-floor-mouseover-area-layer',
      function () {
        mapInstance.setFilter('first-floor-mouseover-layer-hover', [
          'in',
          'ALIAS_NAME',
